...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(i_Clock, i_Reset, i_RX_BMC, i_SW_Reset, 
  o_RX_Data, o_RX_Ready, o_BMC_EOM, o_Data_Size, o_SM_Main)
/* synthesis syn_black_box black_box_pad_pin="i_Reset,i_RX_BMC,i_SW_Reset,o_RX_Data[7:0],o_RX_Ready,o_BMC_EOM,o_Data_Size[7:0],o_SM_Main[7:0]" */
